...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
            ...
            # How many pet images of dogs had their breed correctly classified
            # pet image label indicates the image is-a-dog AND pet image label 
            # and the classifier label match
